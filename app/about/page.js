	...
	return (
		<div className="page-content about">
			...
			<div className="card">
				...
				<div className="link">
					<Link
						href="https://www.linkedin.com/in/freddiekaplan/"
						target="_blank"
				...
				<div className="link">
					<Link
						href="https://www.freetourstockholm.com/"
						target="_blank"
						rel="noopener noreferrer"
					>
			...
			<div className="card">
				<h2>Podcasting</h2>
				<div>
					I am one of the co-hosts for a long running podcast about
					comic books and graphic novels, called Hög av Serier.
				</div>
				<div className="link">
					<Link
						href="https://www.hogavserier.se/"
						target="_blank"
						rel="noopener noreferrer"
					>
